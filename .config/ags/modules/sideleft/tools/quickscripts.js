...
const scripts = [
    ...
    },
    {
        icon: 'obsidian',
        name: 'sync mycelium',
        command: `cd ~/Obsidian/mycelium && git add . && git commit -m \"linux\" && git pull && git push && echo \"Press ENTER to close\" && read`,
        enabled: true
    }
];
            ...
            return Box({
                ...
                children: [
                    ...
                    Button({
                        ...
                        onClicked: () => {
                            closeEverything();
                            execAsync(['kitty', '-e', 'zsh', '-c', script.command]).catch(print)
                                .then(() => {
